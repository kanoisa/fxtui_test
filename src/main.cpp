...
// configuration step. It creates a namespace called `fxtui_test`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        fxtui_test::cmake::project_name,
        fxtui_test::cmake::project_version));// version string, acquired
